...
describe('Server Settings Modal', () => {
    ...
    it('base: updates input text onChange and disables save button with invalid url', async () => {
    ...
    it('base: disables save button on invalid Config response from url', async () => {
    ...
    it('base: disables save button on config request rejection', async () => {
    ...
    it('base: save button is enabled with valid url', async () => {
        user.type(inputBox, validUrl);
