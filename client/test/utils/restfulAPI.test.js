...
describe('restfulAPI', () => {
    ...
    it('base: sendAPIRequest handles valid server response', async () => {
    ...
    it('base: sendAPIRequest response is not ok', async () => {
    ...
    it('base: sendAPIRequest response is rejected', async () => {
    ...
    it('base: sendAPIRequest schema not implemented', async () => {
        fetch.mockResponse(VALID_CONFIG_RESPONSE);
        expect(sendAPIRequest({ requestType: 'notValid' })).rejects.toThrow();
    });

    it('base: sendAPIRequest gives null response for invalid request', async () => {
    ...
    it('base: getOriginalServerUrl', async () => {
